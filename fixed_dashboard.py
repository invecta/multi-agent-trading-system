#!/usr/bin/env python3
"""
Fixed Backtesting Dashboard
Properly handles yfinance data and error cases
"""
import dash
...
def get_stock_data(symbol, start_date, end_date):
    """Get stock data using yfinance with proper error handling"""
    try:
...
def run_backtest_callback(n_clicks, symbol, start_date, end_date, initial_capital):
    ...
    try:
        ...
        if df is None:
            error_msg = f"No data available for {symbol}. Please check your internet connection and try again."
